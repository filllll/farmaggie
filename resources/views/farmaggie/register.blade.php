...
<script type="{{ URL::asset('application/x-javascript') }}"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- font files -->
			...
			<div class="content-wthree1">
				<div class="grid-agileits1">
					...
					<div class="form-control">
						...
						<input type="text" id="name" name="email" placeholder="081-xxx-xxxx" title="โปรดกรอกเบอร์โทรศัพท์" required="">
					</div>
